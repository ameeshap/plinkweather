...
function MapCard(){
  ...
  const title = 'Map';
  const content = 'This is a map card.';  
  ...
  const coords: LatLngExpression = userLocation ? [userLocation.latitude, userLocation.longitude] : defaultCoords;

  return (
    <div className="MapCard">
            <h1>{title}</h1>
            <p>{content}</p>
            <MapContainer center={coords || [41.4993 , -81.6944]} zoom={13} scrollWheelZoom={false}>
